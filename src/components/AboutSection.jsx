      ...
      <div className="pb-20 sm:pb-24 xl:pb-0" style={{ background: '#582e89' }}>
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-x-8 gap-y-10 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch">
          <div className="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-[30rem] xl:flex-none">
            <div className="relative aspect-[2/1] md:aspect-[3/2] h-full md:-mx-8 xl:mx-0 xl:aspect-auto">
              {/* Mobile image */}
              <img
                alt="Francielly Buriti - Fisioterapeuta Neonatal e Pediátrica"
                src="/images/about/profile-mobile.jpg"
                className="absolute inset-0 size-full rounded-2xl object-cover object-top shadow-2xl ring-1 ring-white/15 md:hidden"
              />
              {/* Tablet/Desktop image */}
              <img
                alt="Francielly Buriti - Fisioterapeuta Neonatal e Pediátrica"
                src="/images/about/profile-desktop.jpg"
                className="absolute inset-0 size-full rounded-2xl object-cover object-top shadow-2xl ring-1 ring-white/15 hidden md:block"
              />
            </div>
          </div>
          <div className="w-full max-w-xl xl:max-w-none xl:flex-auto xl:px-12 xl:py-24">
            <figure className="relative isolate pt-6 sm:pt-12">
              <svg
                fill="none"
                viewBox="0 0 162 128"
                aria-hidden="true"
                className="absolute top-0 left-0 -z-10 h-32"
                style={{ stroke: '#6df2f2', opacity: 0.2 }}
              >
                <path
              ...
              <figcaption className="mt-8 text-base">
                <div className="font-semibold text-white">Francielly Buriti</div>
                <div className="mt-1" style={{ color: '#6df2f2' }}>Fisioterapeuta Neonatal e Pediátrica</div>
              </figcaption>
            </figure>
          </div>
        </div>
