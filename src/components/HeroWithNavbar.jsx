      ...
      <header className="absolute inset-x-0 top-0 z-50">
        <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            {navigation.map((item) => (
              <a key={item.name} href={item.href} className="text-sm/6 font-semibold text-gray-900 hover:text-secondary-400 transition-colors">
                {item.name}
              </a>
            ))}
          </div>
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <a
              ...
              className="rounded-md px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:opacity-90 transition-opacity focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
            >
              Agendar Atendimento
            </a>
          </div>
              ...
              <div className="-my-6 divide-y divide-gray-500/10">
                ...
                <div className="py-6">
                  <a
                    ...
                    onClick={() => setMobileMenuOpen(false)}
                    style={{ backgroundImage: 'linear-gradient(to right, #6df2f2, #c53bff)' }}
                    className="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-white hover:opacity-90 transition-opacity text-center"
                  >
                    Agendar Atendimento
                  </a>
                </div>
          ...
          >
            <div
              style={{
                ...
                backgroundImage: 'linear-gradient(to top right, #6df2f2, #c53bff)',
              }}
              className="aspect-[801/1036] w-[50.015625rem] opacity-30"
            />
          </div>
            ...
            <div className="mx-auto max-w-7xl px-6 pt-36 pb-32 sm:pt-60 lg:px-8 lg:pt-32">
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                  <h1 className="text-5xl font-semibold tracking-tight text-pretty sm:text-7xl" style={{ color: '#582e89' }}>
                    Cuidado especializado para o desenvolvimento do seu bebê
                  </h1>
